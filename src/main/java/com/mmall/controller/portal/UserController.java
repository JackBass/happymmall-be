...
public class UserController {
    ...
    @ResponseBody
    public ServerResponse<User> getUserInfor(HttpSession session){
    ...
    public ServerResponse<User> updateInformation(HttpSession session,User user){
        ...
        user.setId(currentUser.getId());//从当前登录用户获取用户ID
        user.setUsername(currentUser.getUsername()); //从当前登录用户获取用户名
